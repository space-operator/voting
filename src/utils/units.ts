import { TokenInfo } from '@/types/mod';
...
export function getMintSupplyAsDecimal(mint: Mint) {
...
// function getMintSupplyPercentageAsBigNumber(mint: Mint, percentage: number) {
